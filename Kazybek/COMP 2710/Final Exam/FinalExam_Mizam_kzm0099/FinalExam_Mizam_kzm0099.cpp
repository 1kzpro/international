...
void *philosopher (void * arg) {
    ...
    // printf("index of i in philosopher: %d \n", i);
...
int main (int argc, char **argv) {
    // For some reason my server had different size void* and int so i could not compile it.
    ...
    for (i=0; i<N; i++) {
        // printf("index of i in pthread_create: %d\n", i);
    ...
    for (i=0; i<N; i++) {
        // printf("index of i in pthread_join: %d\n", i);
        pthread_join(philo[i], NULL);
    }
                                                                       
    // destroy semaphores
    for (i=0; i<N; i++) {
        // printf("index of i in sem_destroy: %d\n", i);
